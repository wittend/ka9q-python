...
Validated against ka9q-radio commit: 9b742e60fd84
...
class StatusType:
    ...
    LIFETIME = 117  # seconds until channel goes away
...
class DemodType:
    ...
    SPECT_DEMOD = 3  # Spectrum analysis pseudo-demod
    SPECT2_DEMOD = 4  # spectrum v2: 8-bit log bins, low-to-high order
    N_DEMOD = 5  # Dummy equal to number of valid entries


# Window types — auto-generated from ka9q-radio/src/window.h
class WindowType:
    """FFT window types — values must match ka9q-radio/src/window.h enum window_type"""

    KAISER_WINDOW = 0
    RECT_WINDOW = 1  # essentially kaiser with beta = 0
    BLACKMAN_WINDOW = 2
    EXACT_BLACKMAN_WINDOW = 3
    GAUSSIAN_WINDOW = 4
    HANN_WINDOW = 5
    HAMMING_WINDOW = 6
    BLACKMAN_HARRIS_WINDOW = 7
    HP5FT_WINDOW = 8
    N_WINDOW = 9
